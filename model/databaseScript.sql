...
SELECT * FROM CULTOS_CUPOS;
SELECT * FROM USUARIO;	
SELECT * FROM USUARIO WHERE ID = 1193116959 AND CONTRASENA = 'Lg276c30' AND ROL = 'PASTOR' AND SEDE ='BRITALIA';
SELECT * FROM CULTO_USUARIO;
SELECT ID,HOUR(INICIO), HOUR(FIN) FROM CULTO;
